...
<div class="topnav1" id="myTopnav">
  <a href="#home" class="active"><img className="image" src="https://sarvamsafety.com/image/catalog/logo1.png" alt=""></img></a>
   <div class="dropdown">
    <button onClick={solutions} class="dropbtn">SOLUTIONS<VscChevronDown style={{marginLeft:175 ,marginTop:-12}}/>
    ...
    <div class="dropdown">
    <button onClick={industry} class="dropbtn">INDUSTRIES<VscChevronDown style={{marginLeft:180,marginTop:-12}}/>
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-content">
    </div>
  ...
  <div class="dropdown">
    <button onClick={about}  class="dropbtn">ABOUT <VscChevronDown style={{marginLeft:155,marginTop:-12}}/>
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-content">
    </div>
  ...
  <div class="dropdown">
    <button onClick={customer} class="dropbtn">CUSTOMER PROJECTS<VscChevronDown style={{marginLeft:225,marginTop:-15}}/>
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-content">
    </div>
